...
use crate::mode::ai::{get_model_list, clear_history, get_session_cost};
...
pub fn handle_command(command: &str) -> String {
    ...
    let cmd = if parts.is_empty() { "".to_string() } else { parts[0].to_lowercase() };
...
fn show_help(args: &[&str]) -> String {
    ...
    Keyboard shortcuts:\n\
      ...
      - ?: Show/hide help overlay".to_string()
}
