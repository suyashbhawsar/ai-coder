...
fn token_counting_benchmark(c: &mut Criterion) {
    ...
    let texts = [
        ...
        std::iter::repeat("The quick brown fox jumps over the lazy dog. ").take(10).collect::<String>(),
        std::iter::repeat("The quick brown fox jumps over the lazy dog. ").take(100).collect::<String>(),
        std::iter::repeat("The quick brown fox jumps over the lazy dog. ").take(1000).collect::<String>(),
    ];
